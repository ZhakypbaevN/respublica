        ...
        <div class="wrapper landing-wrapper litle">
          <div class="news" v-if="announceData">
            ...
            <div class="news-preview withZoomPreview-preview">
              <div class="news-preview-img bg-cover withZoomPreview-preview-img" :style="`background-image: url(https://api.respublica-partiyasy.kz/${announceData.preview_image});`"></div>
            </div>
...
const getAnnounceData = () => {
  const url = `https://api.respublica-partiyasy.kz/api/v1/articles/${route.params.announce_id}`;
  axios({
    method: "get",
    url: url,
  })
...
const getAnnounceList = () => {
  const url = `https://api.respublica-partiyasy.kz/api/v1/articles?offset=0&limit=3&category_id=6`;
  axios({
    method: "get",
    url: url,
  })
