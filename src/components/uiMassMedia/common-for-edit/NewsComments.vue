...
<script setup lang="ts">
  import NewsCommentItem from '@/components/uiMassMedia/common-for-edit/NewsCommentItem.vue';
  import NewsCommentItemSkeleton from '@/components/uiMassMedia/common-for-edit/NewsCommentItemSkeleton.vue';
