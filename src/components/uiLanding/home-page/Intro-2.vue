<template>
  <section class="intro">
    <div class="intro-main">
        <div class="intro-main-preview bg-cover"></div>
...
.intro {
  &-main {
    ...
    &-preview {
      ...
      background-image: url('/img/uiLanding/home/intro/intro-banner-2.jpg');
      ...
      &::after {
        height: 100%;
        z-index: 2;
        background: linear-gradient(0deg, rgba(#042051, .5) 50%, rgba(#042051, 0) 100%);
      }
    }
